Pod::Spec.new do |s|
  ...
  s.homepage          = 'https://github.com/elnygren/AppCenter-SDK-React-Native'
  s.documentation_url = "https://docs.microsoft.com/en-us/appcenter/"

  s.author           = { 'Microsoft' => 'appcentersdk@microsoft.com' }

  s.source = { :http => "https://github.com/elnygren/AppCenter-SDK-React-Native/releases/download/#{s.version}/AppCenter-SDK-ReactNative-iOS-Pod-#{s.version}.zip" }
  s.platform          = :ios, '9.0'
  s.requires_arc      = true
